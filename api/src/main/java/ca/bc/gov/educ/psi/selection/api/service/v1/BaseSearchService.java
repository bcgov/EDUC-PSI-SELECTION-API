...
import ca.bc.gov.educ.psi.selection.api.exception.InvalidParameterException;
import ca.bc.gov.educ.psi.selection.api.filter.BaseFilterSpecs;
import ca.bc.gov.educ.psi.selection.api.filter.FilterOperation;
import ca.bc.gov.educ.psi.selection.api.struct.v1.Condition;
import ca.bc.gov.educ.psi.selection.api.struct.v1.Search;
import ca.bc.gov.educ.psi.selection.api.struct.v1.SearchCriteria;
import ca.bc.gov.educ.psi.selection.api.struct.v1.ValueType;
import ca.bc.gov.educ.psi.selection.api.util.TransformUtil;
