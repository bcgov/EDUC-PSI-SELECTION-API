...
public interface PSISelectionAPIEndpoint {
  ...
  ResponseEntity<List<StudentPsiChoice>> getStudentPSIDetails(@RequestParam(value = "transmissionMode") String transmissionMode,
