package ca.bc.gov.educ.psi.selection.api;
...
@EnableScheduling
public class PSISelectionApiResourceApplication {
  /**
  ...
  public static void main(String[] args) {
    SpringApplication.run(PSISelectionApiResourceApplication.class, args);
  }
