package ca.bc.gov.educ.psi.selection.api.config;
 ...
 */
@Configuration
public class PSISelectionAPIMVCConfig implements WebMvcConfigurer {
   ...
   */
  @Autowired
  public PSISelectionAPIMVCConfig(final RequestResponseInterceptor requestResponseInterceptor) {
